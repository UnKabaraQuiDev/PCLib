...
public interface OctPredicate<A, B, C, D, E, F, G, H> {
	...
	default OctPredicate<A, B, C, D, E, F, G, H>
			and(final OctPredicate<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H> other) {
	...
	default OctPredicate<A, B, C, D, E, F, G, H>
			or(final OctPredicate<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H> other) {
		return (a, b, c, d, e, f, g, h) -> this.test(a, b, c, d, e, f, g, h) || other.test(a, b, c, d, e, f, g, h);
	}
