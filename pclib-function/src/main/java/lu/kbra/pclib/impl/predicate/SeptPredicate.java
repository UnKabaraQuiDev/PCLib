...
public interface SeptPredicate<A, B, C, D, E, F, G> {
	...
	default SeptPredicate<A, B, C, D, E, F, G>
			and(final SeptPredicate<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G> other) {
	...
	default SeptPredicate<A, B, C, D, E, F, G>
			or(final SeptPredicate<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G> other) {
		return (a, b, c, d, e, f, g) -> this.test(a, b, c, d, e, f, g) || other.test(a, b, c, d, e, f, g);
	}
