...
public class QueryableTemplateFactoryBean<T extends SQLQueryable<?>> implements FactoryBean<T> {

	private final AutowireCapableBeanFactory beanFactory;
	private final Class<T> repositoryClass;
	private final QueryableTemplate template;

	public QueryableTemplateFactoryBean(final AutowireCapableBeanFactory beanFactory, final QueryableTemplate template) {
