...
public class ReadOnlyOctuple<A, B, C, D, E, F, G, H> extends Octuple<A, B, C, D, E, F, G, H> {
	...
	public <R1, R2, R3, R4, R5, R6, R7, R8> Octuple<R1, R2, R3, R4, R5, R6, R7, R8> map(
		...
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(funcFirst.apply(a, b, c, d, e, f, g, h),
	...
	public <T> Octuple<A, B, C, D, E, F, G, T> mapEighth(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, c, d, e, f, g, func.apply(a, b, c, d, e, f, g, h)));
	}

	@Override
	public <T> Octuple<A, B, C, D, T, F, G, H> mapFifth(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, c, d, func.apply(a, b, c, d, e, f, g, h), f, g, h));
	}

	@Override
	public <T> Octuple<T, B, C, D, E, F, G, H> mapFirst(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(func.apply(a, b, c, d, e, f, g, h), b, c, d, e, f, g, h));
	}

	@Override
	public <T> Octuple<A, B, C, T, E, F, G, H> mapFourth(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, c, func.apply(a, b, c, d, e, f, g, h), e, f, g, h));
	}

	@Override
	public <T> Octuple<A, T, C, D, E, F, G, H> mapSecond(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, func.apply(a, b, c, d, e, f, g, h), c, d, e, f, g, h));
	}

	@Override
	public <T> Octuple<A, B, C, D, E, F, T, H> mapSeventh(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, c, d, e, f, func.apply(a, b, c, d, e, f, g, h), h));
	}

	@Override
	public <T> Octuple<A, B, C, D, E, T, G, H> mapSixth(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, c, d, e, func.apply(a, b, c, d, e, f, g, h), g, h));
	}

	@Override
	public <T> Octuple<A, B, T, D, E, F, G, H> mapThird(final OctFunction<A, B, C, D, E, F, G, H, T> func) {
		return this.map((a, b, c, d, e, f, g, h) -> new ReadOnlyOctuple<>(a, b, func.apply(a, b, c, d, e, f, g, h), d, e, f, g, h));
	}
