...
import lu.kbra.pclib.db.autobuild.postgres.encoding.decimal.DecimalEncodingType;
...
public class NumberType implements ColumnType<Number, BigDecimal> {

	private final EncodingType<BigDecimal> encodingType;

	public NumberType(final int precision, final int scale) {
