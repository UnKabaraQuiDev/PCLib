...
public class InsertFailedException extends DBException {
	...
	public InsertFailedException(String sql, AbstractDBStructure structure) {
		super(sql, structure);
	}

	public InsertFailedException(String message, String sql, AbstractDBStructure structure) {
		super(message, sql, structure);
	}

	public InsertFailedException(String message, String sql, AbstractDBStructure structure, Throwable e) {
